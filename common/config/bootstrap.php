...
Yii::setAlias('@bbs', realpath(__DIR__ . '/../../bbs'));

//ucenter目录
Yii::setAlias('ucenter', Yii::getAlias('@frontend') . '/web/uc_client/ucenter.php');
...
Yii::setAlias('@bbsUrl', getenv('BBS_URL'));

Yii::setAlias('@ucServer', '@bbsUrl/uc_server/');
