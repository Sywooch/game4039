 ...
 */
return [
	'A confirmation message has been sent to your new email address' => '确认的消息已经发送的您的新邮箱',
	...
	'Confirmation time' => '',
	'Create' => '创建',
	'Credentials will be sent to the user by email' => '凭证将会通过邮件发送给用户',
	'Delete' => '删除',
	'Don\'t have an account? Sign up!' => '',
	'In order to finish your registration, we need you to enter your email address' => '',
	'Invalid or expired link' => '不可用或者过期的链接',
	'New email' => '新邮件',
	'New permission' => '',
	'New role' => '',
	'New user' => '新用户',
	...
	'Thank you, registration is now complete.' => '恭喜,现在你的账号已经注册完毕!',
	'The confirmation link is invalid or expired. Please try requesting a new one.' => '确认连接不可用或者过期了,请尝试重新发送一条新的请求信息',
	'Unconfirmed' => '',
	'Update' => '',
	'User is not found' => '',
	'VKontakte' => '',
	...
	'Your confirmation token is invalid or expired' => '你的确认token不可用或者过期了',
	'Your email address has been changed' => '你的邮箱地址已经改变了',
	'Your password has been changed successfully.' => '你的密码设置成功',
	...
	'Your account has been created and a message with further instructions has been sent to your email' => '你的账号已创建,一封邮件已经发送到您的电子邮箱作为验证',
];
