 ...
 *
 * @property \backend\models\UserProfile $userProfile
 */
class User extends ActiveRecord implements IdentityInterface
{
	...
	public function afterSave($insert, $changedAttributes)
	{
		...
		Buuug7Util::saveInfoToAdminLogTable("{$adminName}添加了一个新管理员({$this->username})");
	...
	public function afterDelete()
	{
		...
		Yii::$app->commandBus->handle(new AddToTimelineCommand([
			...
			'data' => [
				...
				'user_id' => $this->getId(),
				'delete_time' => time(),
				'by_user'=>Yii::$app->user->identity->username,
			]
		]));
